...
![img](https://support.hp.com/wcc-assets/document/images/730/c05194953.jpg)
...
```http
https://www.intel.cn/content/www/cn/zh/download/19727/30163/intel-rapid-storage-technology-raid-for-windows-10-64-bit-for-nuc11pa.html?wapkw=rst-f6vmdflpy-win10-18.0.1.113
```
...
```http
https://www.bilibili.com/opus/639546383090581529
```
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/993da5187b4aa256de74f110e93a1b6d.png)
...
- M.2：M.2 分为 B-Key，M-Key 和 B&M key。B-Key 被称为 Socket 2；支持 SATA 总线和 PCIE2 总线，M-Key 被称为 Socket 3；支持 SATA 总线和 PCIE4.0。
  ...
  ![硬盘插槽和接口](https://i-blog.csdnimg.cn/blog_migrate/1c26ed1bbcf5de947e3764b5e8bd19fe.png)
...
- U.2：在 SAS 上继续改款而来，除了兼容 SATA 和 SAS，还额外提供了 PCIE 4.0 总线的支持，企业级固态都是使用该接口。
  ...
  ![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b4c61ac3c76024837651f3da19e59492.png)

  U.2 在主板上的接口类似于两个 USB 垒起来的形状。

  ![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/b3d38242b142730f340ab05d555dcb6a.png)

参考链接：

```http
https://blog.csdn.net/weixin_45279063/article/details/135607370
```
...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/699193b43c88efaa137893bfc2162e69.png)
...
```http
https://clamowo.lanzouy.com/b05agmvwh
```
